...
class AutoencoderTinyBlock(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, act_fn: str):
        ...
        self.conv = nn.Sequential(
            SVDConv2d(in_channels, out_channels, kernel_size=3, padding=1),
            act_fn,
            SVDConv2d(out_channels, out_channels, kernel_size=3, padding=1),
            act_fn,
            SVDConv2d(out_channels, out_channels, kernel_size=3, padding=1),
        )
        self.skip = (
            SVDConv2d(in_channels, out_channels, kernel_size=1, bias=False)
